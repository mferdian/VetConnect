            ...
            <div class="p-6 mb-8 bg-white shadow-md rounded-xl">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="searchDoctor" placeholder="Nama dokter" class="w-full p-3 pl-10 border border-gray-300 rounded-lg">
                    </div>
                    <div class="relative">
                        ...
                        <div class="mt-2">
                            ...
                            @if ($vet->spesialisasis->isNotEmpty())
                                @foreach ($vet->spesialisasis as $spesialisasi)
                                    <span class="inline-block px-2 py-1 mr-1 text-xs font-semibold text-white bg-[#a0aec0] rounded-full">{{ $spesialisasi->nama_hewan }}</span>
                                @endforeach
                            @else
