...
<head>
    ...
    <title>{{ $article->judul }} - VetConnect</title>
    ...
    <section class="container px-6 mx-auto mt-6 mb-12">
        <div class="max-w-4xl mx-auto">
            ...
            <article class="overflow-hidden bg-white shadow-lg rounded-xl">
                ...
                <!-- Isi Artikel -->
                <div class="p-8 pt-8">
                    <div class="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-img:rounded-xl prose-img:shadow-md prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-ul:text-gray-700 prose-ol:text-gray-700">
                        {!! $article->isi !!}
                    </div>
                </div>
                        ...
                        <div class="p-6 mb-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mb-2 font-medium text-blue-600">{{ $article->vet->spesialisasi ?? 'Dokter Hewan' }}</p>
                                    @if($article->vet->bio)
