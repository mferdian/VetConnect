...
<body class="font-sans bg-gray-100">
   @extends('layouts.app')
    ...
    <div class="container px-4 py-8 mx-auto">
        <div class="max-w-2xl p-8 mx-auto transition duration-300 bg-white rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1">
            {{-- Info Dokter --}}
            ...
            <form method="POST" action="{{ route('booking.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="vet_time_id" class="block mb-2 font-medium text-gray-700">Pilih Jam Konsultasi</label>
                        <select name="vet_time_id" id="vet_time_id" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-600 focus:border-teal-600">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="keluhan" id="keluhan" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-600 focus:border-teal-600" placeholder="Jelaskan kondisi hewan peliharaan Anda..."></textarea>
                    </div>
                </div>
