...
<body class="bg-gray-100">
    ...
    <div class="max-w-6xl px-6 py-12 mx-auto text-center">
        <h2 class="text-2xl font-bold text-green-900 md:text-3xl">what our customers say</h2>
        <p class="mt-2 text-gray-500">Problems trying to resolve the conflict between the two major realms of <br> Classical physics: Newtonian mechanics</p>
        ...
        <div class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-3">
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <p class="text-gray-600">Slate helps you see how many more days you need to work to reach your financial goal.</p>
                <div class="flex flex-col items-center mt-4">
                    <img src="{{ asset('images/PausBeluga.png')}}" alt="User" class="w-10 h-10 rounded-full">
                    <p class="mt-2 font-semibold text-gray-800">John Doe</p>
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="flex flex-col items-center mt-4">
                    <img src="{{ asset('images/PausBeluga.png')}}" alt="User" class="w-10 h-10 rounded-full">
                    <p class="mt-2 font-semibold text-gray-800">Sarah Johnson</p>
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="flex flex-col items-center mt-4">
                    <img src="{{ asset('images/PausBeluga.png')}}" alt="User" class="w-10 h-10 rounded-full">
                    <p class="mt-2 font-semibold text-gray-800">Michael Smith</p>
