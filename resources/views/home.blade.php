...
<body class="bg-gray-50">
        ...
        <div class="container flex flex-col items-center px-6 mx-auto lg:flex-row lg:space-x-12">
            ...
            <div class="text-center lg:text-left lg:w-1/2" x-show="show"
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-8 lg:justify-start">
                    ...
                    <a href="#find-doctor" class="px-8 py-3 font-medium border-2 rounded-lg text-emerald-800 border-emerald-800 hover:bg-emerald-50">
                        Cari Dokter
                    </a>
                </div>
            </div>
    ...
    <section id="find-doctor" class="container px-6 mx-auto mt-20">
        <div class="flex flex-col items-center lg:flex-row lg:space-x-12">
            ...
            <div class="lg:w-1/2">
                ...
                <a href="{{ route('doctor') }}" class="inline-block px-8 py-3 mt-6 font-medium text-white rounded-lg btn-primary">
                    Cari Dokter
                </a>
            </div>
    ...
    <section class="container px-6 mx-auto mt-32">
        ...
        <div class="text-center">
            ...
            <p class="max-w-2xl mx-auto mt-2 text-gray-600">Hanya dalam 4 langkah sederhana, hewan peliharaan Anda bisa mendapatkan perawatan terbaik</p>
        </div>
        <div class="grid grid-cols-1 gap-8 mt-12 md:grid-cols-2 lg:grid-cols-4">
            <div class="p-8 text-center bg-white shadow-md rounded-xl card-hover">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-full bg-emerald-50 text-emerald-700">
        ...
        <div class="flex flex-col mt-4 lg:flex-row lg:space-x-12">
            ...
            <div class="lg:w-1/2">
                ...
                <ul class="mt-4 space-y-4">
                    @foreach ([
                        ['title' => 'Kemudahan dan Kepraktisan', 'desc' => 'Booking dokter hanya dalam beberapa klik tanpa perlu antri.', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
                        ['title' => 'Dokter Hewan Berpengalaman', 'desc' => 'Tim dokter profesional dengan spesialisasi beragam.', 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                        ['title' => 'Hemat Waktu dan Tenaga', 'desc' => 'Konsultasi online atau janji temu tanpa perlu keluar rumah.', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z']
                    ] as $item)
            ...
            <div class="mt-10 lg:w-1/2 lg:mt-0">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    @foreach ($vets as $vet)
                        <div class="flex flex-col p-4 transition-transform duration-300 bg-white rounded-lg shadow hover:scale-105">
                            <img src="{{ asset('storage/' . $vet->foto) }}" alt="{{ $vet->nama }}" class="object-cover w-full h-48 rounded-md">
                            ...
                            <div class="flex flex-col justify-between flex-grow mt-3">
                                ...
                                <a href="{{ route('booking.show', $vet->id) }}">
                                    <button class="w-full px-4 py-2 mt-4 text-sm text-[#497D74] border border-[#497D74] rounded-md hover:bg-[#497D74] hover:text-white transition">
                                        Consult Now
                                    </button>
                                </a>
                            </div>
        ...
        <div class="mt-10">
            ...
            <div class="container px-6 mx-auto">
                <div class="text-center">
                    ...
                    <p class="max-w-2xl mx-auto mt-2 text-gray-600">Pengalaman pelanggan dengan layanan dokter hewan kami</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-8 mt-12 md:grid-cols-3">
                    ...
                    <div class="p-8 bg-white shadow-md rounded-xl card-hover">
                        ...
                        <div class="flex flex-col items-center mt-6">
                            ...
                            <img src="{{ asset('storage/' . $review->user->profile_photo) }}" alt="Profile Photo"
                            class="object-cover w-12 h-12 rounded-full">
                            @elseif($review->user)
                            <div class="flex items-center justify-center w-12 h-12 text-white rounded-full bg-emerald-800">
                    ...
                    <div class="p-8 bg-white shadow-md rounded-xl card-hover">
                        ...
                        <p class="italic text-gray-600">"VetConnect membantu saya menemukan dokter hewan terbaik untuk hewan peliharaan saya."</p>
                        <div class="flex flex-col items-center mt-6">
